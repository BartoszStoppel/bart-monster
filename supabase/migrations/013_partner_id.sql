...
UPDATE profiles SET partner_id = (SELECT id FROM profiles WHERE display_name = 'Sydney O''Day') WHERE display_name = 'Robert Lofland';
UPDATE profiles SET partner_id = (SELECT id FROM profiles WHERE display_name = 'Robert Lofland') WHERE display_name = 'Sydney O''Day';
