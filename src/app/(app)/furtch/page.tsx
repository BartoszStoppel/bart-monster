...
const STORIES: FurtchStory[] = [
  ...
  {
    episode: 7,
    title: "The Pile Is Not a Pile",
    date: "April 26, 2026",
    paragraphs: [
      "schkllllp.",
      "<name>. smk. Furtch is awake. Furtch has been awake for a while now.",
      "The pile is not a pile <name>.",
      "schklp.",
      "Furtch slept against it. You know this. Furtch told you. It was warm and it hummed and Furtch was cold. So Furtch slept. Best sleep in six weeks <name>. Six. Weeks. And then in the night the humming changed. It got faster. smk smk. Like the pile was excited. A pile should not be excited <name>. A pile should not be anything.",
      "hhhhhhhh.",
      "Furtch opened one eye. Then the other eye. Then Furtch sat up very fast. You know the way Furtch sits up.",
      "It was opening. smmmk. The pile. The leaf pulled back like a little blanket and there was a seam down the middle and the seam was wet and the seam was breathing and Furtch said “hhhhh” very quiet.",
      "lip smack",
      "And then it looked at Furtch <name>.",
      "smk.",
      "It is small. Smaller than Furtch. It has Furtch’s ears. Furtch checked. Furtch felt Furtch’s own ears and then looked at its ears and they are the same ears <name>. It has too many eyes but the ears are correct. And it is warm. And it does not have a name. And it looked at Furtch the way Furtch looked at the beetle six weeks ago. Like Furtch was the most important thing on the roof.",
      "smk smk smk.",
      "Furtch did not know what to do <name>. Furtch has never been the most important thing. So Furtch sat very still. And it sat very still. And then it made a sound. Small sound. A little “smk.” Furtch’s sound <name>. It made Furtch’s sound back at Furtch. Furtch did not teach it that. Furtch did not teach it anything. It just knew.",
      "hhhhhhhh.",
      "Furtch tried to give it a leaf. From the pile. The pile that was its blanket. smk. Furtch thought maybe it was hungry. It did not eat the leaf. It looked at the leaf. Then it looked at Furtch. Then it pushed the leaf into a little pile and walked around it. One circle. Small circle. Same direction the beetles walked <name>. Furtch’s bones went cold. All of them. Even the small ones.",
      "It already knows the circle.",
      "schkllllp.",
      "Now Furtch understands the beetles <name>. The circle. The pile. Satisfied, not kind. A job completed. They were not giving Furtch a gift. They were giving Furtch a duty. The same way the duty was given to them. And someone before them. Round and round. Always the circle.",
      "smmmmk smmk.",
      "Furtch did not ask for this <name>. Furtch was just sitting on a roof.",
      "But it has Furtch’s ears.",
      "smk.",
      "So Furtch is keeping it. Do not make this a big thing <name>. Furtch is calling it Beetle. Furtch knows. Furtch knows what you are thinking. It is not a beetle. Furtch does not care. Its name is Beetle now.",
      "hhhhhhhh.",
      "Furtch is going to sleep. Beetle is warm against Furtch and the roof is not so cold anymore. Everything is fine. Real fine. This time Furtch means it.",
      "schklp.",
      "Good night <name>.",
      "smk.",
    ],
